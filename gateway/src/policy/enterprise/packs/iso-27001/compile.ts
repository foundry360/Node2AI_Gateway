...
export type CompiledIso27001Pack = {
  pack_id: string;
  pack_version: string;
  rules: Iso27001CompiledRule[];
...
function packRootCandidates(): string[] {
  ...
  return [
    join(process.cwd(), 'policy-packs', 'iso-27001'),
    join(here, '../../../../../policy-packs/iso-27001'),
    join(here, '../../../../../../policy-packs/iso-27001'),
  ];
}
...
export function loadIso27001PackSources(): {
  root: string | null;
  rules: Iso27001CompiledRule[];
  provenance: PackProvenanceGraph;
} {
  for (const root of packRootCandidates()) {
    ...
    try {
      ...
      let provenance: PackProvenanceGraph = structuredClone(ISO_27001_PROVENANCE_GRAPH);
  ...
  return {
    ...
    provenance: ISO_27001_PROVENANCE_GRAPH,
  };
}

export function compileIso27001Pack(): CompiledIso27001Pack {
  const loaded = loadIso27001PackSources();
  const policies: PackPolicyMeta[] = [
    {
      ...
      description:
        'Applies ISO/IEC 27001:2022 as Enigma ISMS information-security governance evidence gates. Standard — does not certify ISO 27001 compliance or produce a security score.',
      owner: 'compliance',
      priority: 110,
      scope_tier: 'standard',
      domain: 'ai_risk',
      content_hash: 'sha256:iso_27001_pack_v1',
      pack_name: 'ISO/IEC 27001',
      pack_version: ISO_27001_PACK_META.pack_version,
    },
    {
      ...
      description:
        'Adds complementary Enigma logging for ISO/IEC 27001-scoped responses (security monitoring family).',
      owner: 'compliance',
      priority: 110,
      scope_tier: 'standard',
      domain: 'ai_risk',
      content_hash: 'sha256:iso_27001_pack_v1_output',
      pack_name: 'ISO/IEC 27001',
      pack_version: ISO_27001_PACK_META.pack_version,
    },
  ];
