...
export type CompiledIso23894Pack = {
  pack_id: string;
  pack_version: string;
  rules: Iso23894CompiledRule[];
...
function packRootCandidates(): string[] {
  ...
  return [
    join(process.cwd(), 'policy-packs', 'iso-23894'),
    join(here, '../../../../../policy-packs/iso-23894'),
    join(here, '../../../../../../policy-packs/iso-23894'),
  ];
}
...
export function loadIso23894PackSources(): {
  root: string | null;
  rules: Iso23894CompiledRule[];
  provenance: PackProvenanceGraph;
} {
  for (const root of packRootCandidates()) {
    ...
    try {
      ...
      let provenance: PackProvenanceGraph = structuredClone(ISO_23894_PROVENANCE_GRAPH);
  ...
  return {
    ...
    provenance: ISO_23894_PROVENANCE_GRAPH,
  };
}

export function compileIso23894Pack(): CompiledIso23894Pack {
  const loaded = loadIso23894PackSources();
  const policies: PackPolicyMeta[] = [
    {
      ...
      description:
        'Applies ISO/IEC 23894:2023 as Enigma AI risk-management evidence gates. Standard — does not certify ISO compliance or produce a risk score.',
      owner: 'compliance',
      priority: 125,
      scope_tier: 'standard',
      domain: 'ai_risk',
      content_hash: 'sha256:iso_23894_pack_v1',
      pack_name: 'ISO/IEC 23894',
      pack_version: ISO_23894_PACK_META.pack_version,
    },
    {
      ...
      description:
        'Adds complementary Enigma logging for ISO 23894-scoped responses (risk monitoring family).',
      owner: 'compliance',
      priority: 125,
      scope_tier: 'standard',
      domain: 'ai_risk',
      content_hash: 'sha256:iso_23894_pack_v1_output',
      pack_name: 'ISO/IEC 23894',
      pack_version: ISO_23894_PACK_META.pack_version,
    },
  ];
