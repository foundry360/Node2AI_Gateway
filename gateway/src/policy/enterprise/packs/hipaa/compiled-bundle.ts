  ...
  },
{
  ...
  },
  {
    ...
    priority: 90,
    requirement_type: "DERIVED_CONTROL",
    conditions: { regulatory_applicability: "HIPAA", classification: "PHI", operation_in: ["write"] },
    decision: "REVIEW",
    ...
    source_type: "DERIVED_CONTROL",
    derived_from: ["src_45cfr164"],
    note: "WRITE is not an automatic DENY. High-risk PHI write requires human approval.",
  },
  {
