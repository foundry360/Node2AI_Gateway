  ...
  },
{
  ...
  },
  {
    ...
    priority: 40,
    requirement_type: "IMPLEMENTATION_OPTION",
    conditions: { regulatory_applicability: "HIPAA", classification: "PHI", has_entity_spans: true, trust_level_not: "trusted" },
    decision: "TRANSFORM",
  ...
  },
  {
    ...
    priority: 55,
    requirement_type: "IMPLEMENTATION_OPTION",
    conditions: { regulatory_applicability: "HIPAA", classification: "PHI", processing_environment: "unauthorized_external", required_controls_satisfied: true, has_entity_spans: true },
    decision: "TRANSFORM",
