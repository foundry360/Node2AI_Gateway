...
export type CompiledIso27701Pack = {
  pack_id: string;
  pack_version: string;
  rules: Iso27701CompiledRule[];
...
function packRootCandidates(): string[] {
  ...
  return [
    join(process.cwd(), 'policy-packs', 'iso-27701'),
    join(here, '../../../../../policy-packs/iso-27701'),
    join(here, '../../../../../../policy-packs/iso-27701'),
  ];
}
...
export function loadIso27701PackSources(): {
  root: string | null;
  rules: Iso27701CompiledRule[];
  provenance: PackProvenanceGraph;
} {
  for (const root of packRootCandidates()) {
    ...
    try {
      ...
      let provenance: PackProvenanceGraph = structuredClone(ISO_27701_PROVENANCE_GRAPH);
  ...
  return {
    ...
    provenance: ISO_27701_PROVENANCE_GRAPH,
  };
}

export function compileIso27701Pack(): CompiledIso27701Pack {
  const loaded = loadIso27701PackSources();
  const policies: PackPolicyMeta[] = [
    {
      ...
      description:
        'Applies ISO/IEC 27701:2025 as Enigma PIMS privacy-information-management governance evidence gates. Standard — does not certify ISO 27701 compliance or produce a privacy score.',
      owner: 'compliance',
      priority: 110,
      scope_tier: 'standard',
      domain: 'ai_risk',
      content_hash: 'sha256:iso_27701_pack_v1',
      pack_name: 'ISO/IEC 27701',
      pack_version: ISO_27701_PACK_META.pack_version,
    },
    {
      ...
      description:
        'Adds complementary Enigma logging for ISO/IEC 27701-scoped responses (privacy monitoring family).',
      owner: 'compliance',
      priority: 110,
      scope_tier: 'standard',
      domain: 'ai_risk',
      content_hash: 'sha256:iso_27701_pack_v1_output',
      pack_name: 'ISO/IEC 27701',
      pack_version: ISO_27701_PACK_META.pack_version,
    },
  ];
