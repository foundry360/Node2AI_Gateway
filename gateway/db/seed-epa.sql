...
(
  ...
  'ai_risk',
  'SOC 2 / AICPA Trust Services Criteria pack v1.0 — enterprise assurance evidence gates as Enigma controls. Architecture Pack #9. Framework — not certification, legal authority, audit opinion, or compliance score.',
  'active'
),
(
  'pack_nist_csf_2',
  'NIST CSF 2.0',
  'ai_risk',
  'NIST Cybersecurity Framework (CSF) 2.0 pack v1.0 — cybersecurity governance evidence gates as Enigma controls. Architecture Pack #10. Framework — not certification, SIEM, score, or assessment product.',
  'active'
),
(
  'pack_iso_38507',
  'ISO/IEC 38507',
  'ai_risk',
  'ISO/IEC 38507:2022 pack v1.0 — organizational AI governance evidence gates as Enigma controls. Architecture Pack #11. Standard — not certification, board GRC, maturity score, or assessment product.',
  'active'
),
(
  'pack_iso_27001',
  'ISO/IEC 27001',
  'ai_risk',
  'ISO/IEC 27001:2022 pack v1.0 — ISMS information-security governance evidence gates as Enigma controls. Architecture Pack #12. Standard — not certification, SIEM, Annex A score, or assessment product.',
  'active'
),
(
  'pack_iso_27701',
  'ISO/IEC 27701',
  'ai_risk',
  'ISO/IEC 27701:2025 pack v1.0 — PIMS privacy-information-management governance evidence gates as Enigma controls. Architecture Pack #13. Standard — not certification, GDPR determination, DSAR/DPIA workflow, or privacy score.',
  'active'
),
(
  ...
  'ai_risk',
  'NIST Privacy Framework 1.0 (CSWP 10) pack v1.0 — privacy-risk governance evidence gates as Enigma controls under privacy.nist_pf. Architecture Pack #14. Framework — not certification, GDPR/HIPAA determination, DSAR/DPIA workflow, or privacy score.',
  'active'
),
(
  'pack_financial',
...
(
  ...
  'pack_soc2',
  NULL,
  'SOC 2 input governance',
  'SOC 2 pack v1 input — SOC 2-informed enterprise assurance evidence gates as Enigma controls.',
  'enigma',
  'ai_risk',
  'seed'
),
(
  ...
  'pack_soc2',
  NULL,
  'SOC 2 output governance',
  'SOC 2 pack v1 output — complementary governance logging.',
  'enigma',
  'ai_risk',
  'seed'
),
(
  ...
  'pack_nist_csf_2',
  NULL,
  'NIST CSF 2.0 input governance',
  'NIST CSF 2.0 pack v1 input — cybersecurity governance evidence gates as Enigma controls.',
  'enigma',
  'ai_risk',
  'seed'
),
(
  ...
  'pack_nist_csf_2',
  NULL,
  'NIST CSF 2.0 output governance',
  'NIST CSF 2.0 pack v1 output — complementary governance logging.',
  'enigma',
  'ai_risk',
  'seed'
),
(
  ...
  'pack_iso_38507',
  NULL,
  'ISO/IEC 38507 input governance',
  'ISO/IEC 38507 pack v1 input — organizational AI governance evidence gates as Enigma controls.',
  'enigma',
  'ai_risk',
  'seed'
),
(
  ...
  'pack_iso_38507',
  NULL,
  'ISO/IEC 38507 output governance',
  'ISO/IEC 38507 pack v1 output — complementary governance logging.',
  'enigma',
  'ai_risk',
  'seed'
),
(
  ...
  'pack_iso_27001',
  NULL,
  'ISO/IEC 27001 input governance',
  'ISO/IEC 27001 pack v1 input — ISMS information-security governance evidence gates as Enigma controls.',
  'enigma',
  'ai_risk',
  'seed'
),
(
  ...
  'pack_iso_27001',
  NULL,
  'ISO/IEC 27001 output governance',
  'ISO/IEC 27001 pack v1 output — complementary governance logging.',
  'enigma',
  'ai_risk',
  'seed'
),
(
  ...
  'pack_iso_27701',
  NULL,
  'ISO/IEC 27701 input governance',
  'ISO/IEC 27701 pack v1 input — PIMS privacy-information-management governance evidence gates as Enigma controls.',
  'enigma',
  'ai_risk',
  'seed'
),
(
  ...
  'pack_iso_27701',
  NULL,
  'ISO/IEC 27701 output governance',
  'ISO/IEC 27701 pack v1 output — complementary governance logging.',
  'enigma',
  'ai_risk',
  'seed'
),
(
  ...
  'pack_nist_privacy_framework',
  NULL,
  'NIST Privacy Framework input governance',
  'NIST Privacy Framework 1.0 pack v1 input — privacy-risk governance evidence gates under privacy.nist_pf as Enigma controls.',
  'enigma',
  'ai_risk',
  'seed'
),
(
  ...
  'pack_nist_privacy_framework',
  NULL,
  'NIST Privacy Framework output governance',
  'NIST Privacy Framework 1.0 pack v1 output — complementary governance logging.',
  'enigma',
  'ai_risk',
  'seed'
),
...
(
  ...
  now(),
  'seed',
  'SOC 2 pack v1.0 input — SOC 2-informed enterprise assurance evidence gates',
  'sha256:soc2_pack_v1',
  '[{"interpreter":"soc2_pack_v1"}]'::jsonb,
  'seed'
),
(
  'pv_pol_soc2_output_v1',
  'pol_soc2_output',
  1,
  'active',
  115,
  ...
  now(),
  'seed',
  'SOC 2 pack v1.0 output — complementary governance log',
  'sha256:soc2_pack_v1_output',
  '[{"interpreter":"soc2_pack_v1_output"}]'::jsonb,
  'seed'
),
(
  'pv_pol_nist_csf_2_input_v1',
  'pol_nist_csf_2_input',
  1,
  'active',
  110,
  ...
  now(),
  'seed',
  'NIST CSF 2.0 pack v1.0 input — cybersecurity governance evidence gates',
  'sha256:nist_csf_2_pack_v1',
  '[{"interpreter":"nist_csf_2_pack_v1"}]'::jsonb,
  'seed'
),
(
  'pv_pol_nist_csf_2_output_v1',
  'pol_nist_csf_2_output',
  1,
  'active',
  110,
  ...
  now(),
  'seed',
  'NIST CSF 2.0 pack v1.0 output — complementary governance log',
  'sha256:nist_csf_2_pack_v1_output',
  '[{"interpreter":"nist_csf_2_pack_v1_output"}]'::jsonb,
  'seed'
),
(
  'pv_pol_iso_38507_input_v1',
  'pol_iso_38507_input',
  1,
  'active',
  110,
  ...
  now(),
  'seed',
  'ISO/IEC 38507 pack v1.0 input — organizational AI governance evidence gates',
  'sha256:iso_38507_pack_v1',
  '[{"interpreter":"iso_38507_pack_v1"}]'::jsonb,
  'seed'
),
(
  'pv_pol_iso_38507_output_v1',
  'pol_iso_38507_output',
  1,
  'active',
  110,
  ...
  now(),
  'seed',
  'ISO/IEC 38507 pack v1.0 output — complementary governance log',
  'sha256:iso_38507_pack_v1_output',
  '[{"interpreter":"iso_38507_pack_v1_output"}]'::jsonb,
  'seed'
),
(
  'pv_pol_iso_27001_input_v1',
  'pol_iso_27001_input',
  1,
  'active',
  110,
  ...
  now(),
  'seed',
  'ISO/IEC 27001 pack v1.0 input — ISMS information-security governance evidence gates',
  'sha256:iso_27001_pack_v1',
  '[{"interpreter":"iso_27001_pack_v1"}]'::jsonb,
  'seed'
),
(
  'pv_pol_iso_27001_output_v1',
  'pol_iso_27001_output',
  1,
  'active',
  110,
  ...
  now(),
  'seed',
  'ISO/IEC 27001 pack v1.0 output — complementary governance log',
  'sha256:iso_27001_pack_v1_output',
  '[{"interpreter":"iso_27001_pack_v1_output"}]'::jsonb,
  'seed'
),
(
  'pv_pol_iso_27701_input_v1',
  'pol_iso_27701_input',
  1,
  'active',
  110,
  ...
  now(),
  'seed',
  'ISO/IEC 27701 pack v1.0 input — PIMS privacy-information-management governance evidence gates',
  'sha256:iso_27701_pack_v1',
  '[{"interpreter":"iso_27701_pack_v1"}]'::jsonb,
  'seed'
),
(
  'pv_pol_iso_27701_output_v1',
  'pol_iso_27701_output',
  1,
  'active',
  110,
  ...
  now(),
  'seed',
  'ISO/IEC 27701 pack v1.0 output — complementary governance log',
  'sha256:iso_27701_pack_v1_output',
  '[{"interpreter":"iso_27701_pack_v1_output"}]'::jsonb,
  'seed'
),
(
  'pv_pol_nist_privacy_framework_input_v1',
  'pol_nist_privacy_framework_input',
  1,
  'active',
  110,
  ...
  now(),
  'seed',
  'NIST Privacy Framework 1.0 pack v1.0 input — privacy-risk governance evidence gates under privacy.nist_pf',
  'sha256:nist_privacy_framework_pack_v1',
  '[{"interpreter":"nist_privacy_framework_pack_v1"}]'::jsonb,
  'seed'
),
(
  'pv_pol_nist_privacy_framework_output_v1',
  'pol_nist_privacy_framework_output',
  1,
  'active',
  110,
  ...
  now(),
  'seed',
  'NIST Privacy Framework 1.0 pack v1.0 output — complementary governance log',
  'sha256:nist_privacy_framework_pack_v1_output',
  '[{"interpreter":"nist_privacy_framework_pack_v1_output"}]'::jsonb,
  'seed'
),
(
